<form action="{{ route('votarPropuestaMP') }}" method="POST">
    {{ csrf_field() }}
    <input type="text" name="vocaliaActual" id="vocaliaActual" style="display: none !important" value="{{$vocaliaActual['id']}}" />
    <br> <strong> <h4 style="color:green">{{__('text.selectPropuestasSep')}}</h4> </strong>

    <br> <h5>{{__('text.selectPropuestas')}}</h5>
    <div class="row justify-content-md-center">
        <div class="col-6">
            <br> <h5>{{__('text.M_mayores')}}</h5>
            <select class="selectpicker w-auto" multiple data-done-button="true" id="propuestaSelectM[]" data-max-options="3" name="propuestaSelectM[]" style="width: 100% !important;">
        ...
        <div class="col-6">
            <br> <h5>{{__('text.M_menores')}}</h5>
            <select class="selectpicker w-auto" multiple data-done-button="true" id="propuestaSelectP[]" data-max-options="3" name="propuestaSelectP[]" style="width: 100% !important;">
                @foreach($propuestas as $propuesta)
                    @if($propuesta['cantidad'] <= $cantPropMen)
                        <option value='{{$propuesta['id']}}' @if($propuesta['votado']) selected @endif)>{{$propuesta['propuesta']}}
                        </option>
